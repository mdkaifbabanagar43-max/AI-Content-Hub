...
db = firestore.client()
BUCKET_NAME = "shortcutai-backend.firebasestorage.app"
...
def update_job_status(user_id, job_id, status, error_msg=None, **kwargs):
    """
    Updates job status (e.g., to 'failed' or 'completed').
    Accepts extra kwargs like result_url.
    """
    try:
