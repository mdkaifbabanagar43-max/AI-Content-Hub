...
export const handleAppError = (error: unknown, refundCallback?: () => void) => {
    ...
    } else if (errorString.includes('Anti-Bot Blocked')) {
        message = "YouTube blocked the download.";
        description = "This video is private, age-restricted, or protected by YouTube. Please try another video.";
