    ...
    return (
        <div className="py-16 sm:py-24 font-sans">
            <div className="w-full max-w-[1400px] mx-auto px-6 lg:px-8">
                            ...
                            <ul className="space-y-4 mb-8 flex-1">
                                {plan.features.map((feature, i) => (
                                    <li key={i} className="flex items-start gap-3 text-zinc-300 text-sm">
                                        <Check className={cn("w-5 h-5 shrink-0", plan.highlight ? "text-indigo-400" : "text-zinc-600")} />
                                        {feature}
                                    </li>
                                ))}
                            </ul>
                ...
                <div className="max-w-3xl mx-auto text-center mt-12 text-zinc-600 text-sm italic">
