            ...
            <div className="w-full max-w-[1800px] mx-auto px-6 md:px-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-4">
                        <h3 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">
                            AI Studio.
                        </h3>
                        <p className="text-zinc-400 text-lg leading-relaxed">
                            Empowering creators with next-generation AI tools. Turn your ideas into viral reality.
                        </p>
                    </div>
                ...
                <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-zinc-500 text-lg">
                        © {new Date().getFullYear()} AI Studio SaaS. All rights reserved.
                    </p>
