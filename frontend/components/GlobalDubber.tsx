...
export default function GlobalDubber({ onNavigate }: { onNavigate?: (tab: string) => void }) {
    // --- State ---
    ...
    const executeGeneration = async () => {
        ...
        if (!success) {
            toast.error('Insufficient credits.', { description: 'Please upgrade your plan or wait for your monthly reset.' });
            return;
        }
        ...
        try {
            ...
            if (file.size > 20 * 1024 * 1024) {
                ...
                backendResponse = await fetch(`${API_BASE_URL}/dub-video`, {
                    method: 'POST',
                    body: formData,
                    headers: { 'Authorization': `Bearer ${token}` }
                });
        ...
        <div className="max-w-[1000px] mx-auto p-6 min-h-screen font-sans flex flex-col justify-center">
            ...
            <div className="mb-12">
                <div className="flex justify-between relative">
                    ...
                    {/* Active Line */}
                    <div
                        className="absolute top-1/2 left-0 h-1 bg-purple-500 -z-10 -translate-y-1/2 rounded-full transition-all duration-500"
                        ...
                        return (
                            <div key={step.num} className="flex flex-col items-center gap-2">
                                <div className={cn(
                                    ...
                                    isActive ? "bg-purple-600 border-black text-white shadow-xl shadow-purple-500/30" : "bg-zinc-900 border-zinc-800 text-zinc-500"
                                )}>
                    ...
                    <div className="space-y-8 animate-in slide-in-from-right-4 duration-500">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div
                                ...
                                className={cn(
                                    "border-2 border-dashed rounded-3xl p-8 flex flex-col items-center justify-center text-center cursor-pointer transition-all duration-300 group hover:border-purple-500 hover:bg-zinc-900/50 min-h-[250px]",
                                    file ? "border-purple-500 bg-purple-500/5" : "border-zinc-700"
                                )}
                            >
                                ...
                                {file ? (
                                    <div className="animate-in zoom-in duration-300">
                                        <div className="w-16 h-16 bg-purple-600 rounded-2xl flex items-center justify-center mx-auto shadow-lg shadow-purple-500/20 mb-4">
                                    ...
                                    <div className="space-y-4">
                                        <div className="w-16 h-16 bg-zinc-800 rounded-full flex items-center justify-center mx-auto group-hover:scale-110 transition-transform">
                                            <UploadCloud size={32} className="text-zinc-500 group-hover:text-purple-400" />
                                        </div>
                                        <div>
                                ...
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        selectedVoiceId === voice.id
                                            ? "bg-gradient-to-r from-purple-900/40 to-pink-900/40 border-purple-500 ring-1 ring-purple-500/50"
                                            : "bg-zinc-900/50 border-zinc-800 hover:border-zinc-600"
                                    )}
                                >
                                    <div className={cn(
                                        "w-12 h-12 rounded-full flex items-center justify-center font-bold text-sm shrink-0",
                                        selectedVoiceId === voice.id ? "bg-purple-600 text-white" : "bg-zinc-800 text-zinc-500"
                                    )}>
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            playingVoiceId === voice.id ? "bg-red-500 text-white animate-pulse" : "bg-zinc-800 text-zinc-400 hover:bg-purple-600 hover:text-white"
                                        )}
                ...
                {currentStep === 3 && (
                    <div className="space-y-8 animate-in slide-in-from-right-4 duration-500">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {/* Option B: Lip Sync (Coming Soon) */}
                            <div
                                className={cn(
                                    "p-8 rounded-[2rem] border-2 relative overflow-hidden opacity-50 cursor-not-allowed",
                                    "border-zinc-800 bg-zinc-900/50"
                                )}
                            >
                                <div className="absolute top-4 right-4 bg-yellow-500 text-black text-xs font-bold px-3 py-1 rounded-full">COMING SOON</div>
                                ...
                                <div className="inline-block bg-purple-500/10 text-purple-400 text-xs font-bold px-2 py-1 rounded mb-4">PREMIUM</div>

                                <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                                    Matches mouth movements to the new audio.
                                    Coming soon with advanced AI lip syncing.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    {!finalVideoUrl && (
                        <button
                            ...
                            className={cn(
                                ...
                                currentStep === 4
                                    ? (userPlan === 'free' ? "bg-zinc-800 text-zinc-400 hover:bg-zinc-700 checkbox-locked" : "bg-gradient-to-r from-purple-600 to-pink-600 text-white hover:shadow-purple-500/25 hover:scale-105")
